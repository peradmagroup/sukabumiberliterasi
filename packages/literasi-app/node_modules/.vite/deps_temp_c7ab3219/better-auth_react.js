...
var _getEnv = (useShim) => {
  var _a, _b;
  return ((_a = globalThis.process) == null ? void 0 : _a.env) || ((_b = globalThis.Deno) == null ? void 0 : _b.env.toObject()) || globalThis.__env__ || (useShim ? _envShim : globalThis);
};
...
var createLogger = (options) => {
  ...
  const logLevel = (options == null ? void 0 : options.level) ?? "warn";
  const colorsEnabled = (options == null ? void 0 : options.disableColors) !== void 0 ? !options.disableColors : getColorDepth() !== 1;
...
var InternalAPIError = class extends Error {
  constructor(status = "INTERNAL_SERVER_ERROR", body = void 0, headers = {}, statusCode = typeof status === "number" ? status : statusCodes[status]) {
    super(body == null ? void 0 : body.message, (body == null ? void 0 : body.cause) ? { cause: body.cause } : void 0);
    this.status = status;
    this.body = body;
...
var redirectPlugin = {
  ...
  hooks: { onSuccess(context) {
    var _a, _b;
    if (((_a = context.data) == null ? void 0 : _a.url) && ((_b = context.data) == null ? void 0 : _b.redirect) && isSafeUrlScheme(context.data.url)) {
  ...
  const fetchSession = async (queryParams) => {
    ...
    try {
      const res = await $fetch("/get-session", {
        method: "GET",
        query: queryParams == null ? void 0 : queryParams.query,
      ...
      if (data == null ? void 0 : data.needsRefresh) try {
      ...
      if (error) {
        ...
        const isUnauthorized = (error == null ? void 0 : error.status) === 401;
        session.set({
...
var getClientConfig = (options, loadEnv) => {
  ...
  const baseURL = getBaseURL(options == null ? void 0 : options.baseURL, options == null ? void 0 : options.basePath, void 0, loadEnv) ?? resolvePublicAuthUrl(options == null ? void 0 : options.basePath) ?? "/api/auth";
  ...
  for (const plugin of plugins) if (plugin.getActions) pluginsActions = defu(((_g = plugin.getActions) == null ? void 0 : _g.call(plugin, $fetch, $store, options)) ?? {}, pluginsActions);
  return {
    get baseURL() {
      return baseURL;
    },
        ...
        return await client(routePath, {
          ...
          async onSuccess(context) {
            ...
            for (const match of matches) {
              ...
              (_b = match.callback) == null ? void 0 : _b.call(match, routePath);
            }
          }
        });
      }
